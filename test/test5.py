...
image_file = '/home/aclass/dl/test/images/test.jpg'
npload = caffe_root+ 'python/caffe/imagenet/ilsvrc_2012_mean.npy'

net = caffe.Classifier(model_file, pretrained,mean=np.load(caffe_root + 'python/caffe/imagenet/ilsvrc_2012_mean.npy'),
